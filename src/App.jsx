        ...
        {!activeStationId && (
          <div className="max-w-[1500px] mx-auto pt-10 pb-20 animate-in fade-in duration-1000">
             ...
             <div className="text-center mb-12 flex flex-col items-center">
                 ...
                 <p className="text-cyan-300 text-lg sm:text-3xl md:text-4xl font-light tracking-[0.1em] sm:tracking-[0.2em] uppercase drop-shadow-md text-center"><span className="font-black text-orange-400">יישומים</span> בביוטכנולוגיה</p>
